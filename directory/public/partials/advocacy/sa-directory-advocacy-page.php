...
$directory_seo_title = returnAdvocacySeoDetails()['title'] ?? '';
$directory_seo_desc = returnAdvocacySeoDetails()['description'] ?? '';
get_header();
    ...
    <div class="o-section__wrapper">
        <div class="home--block">
            <div class="title">
                ...
                <p>Easily communicate with all lawmakers or groups of lawmakers. Target your messages by chamber, caucus, committee or committee caucus.</p>
            </div>
            <?php
            $fullurl = null;
        ...
        ?>
        <div class="dir-landing--itemBlock">
            <p>select a group to contact</p>
            <div class="dir-landing--items">
                <?php foreach ($advocacyLists as $item) {
                ?>
